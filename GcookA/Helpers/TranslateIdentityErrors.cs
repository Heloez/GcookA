...
public static class TranslateIdentityErrors
{
    public static string TranslateErrorMessage(string codeError)
    {
        string message = codeError switch
        {
            ...
            "UserLockoutNotEnable" => "Lockout não está habilitado para este usuário.",
            "UserAlreadyHasPassword" => "Usuário já possui em uma senha definida.",
            ...
            "PasswordRequiresLower" => "Senhas devem conter ao menos um caracter em caixa alta ('A' - 'Z').",
